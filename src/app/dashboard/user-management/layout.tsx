...
const nav = [
  { label: "Admins", href: "/dashboard/user-management/admins" },
  { label: "Agents", href: "/dashboard/user-management/agents" },
  { label: "Customers", href: "/dashboard/user-management/customers" },
