...
interface SettlementCounterClientProps {
  settlementId: string;
}

export default function SettlementCounterClient({ settlementId }: SettlementCounterClientProps) {
  const router = useRouter();
  console.log('Processing counter offer for settlement:', settlementId);
