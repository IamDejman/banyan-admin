...
interface SettlementCompleteClientProps {
  settlementId: string;
}

export default function SettlementCompleteClient({ settlementId }: SettlementCompleteClientProps) {
  const router = useRouter();
  console.log('Completing settlement:', settlementId);
